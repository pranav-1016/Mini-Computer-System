...
#define CONST_VALUE_MIN INT_MIN
#define CONST_VALUE_MAX INT_MAX

/* Instruction operands are still encoded as one byte. */
#define ENCODED_OPERAND_MIN 0
#define ENCODED_OPERAND_MAX 255
